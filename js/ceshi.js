...
/******/ ([
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var scrollX = 11945 - 40 + 20 + 10 + 40 + 30;
        ...
        var o_point = { x: 675, y: 375 },
            tmp_x = 0,
            s = 0,
            scale_v = void 0,
                start_X = void 0,
                    hasScaled = false;
        var o_point_3_4 = { x: 200, y: 355 },
            tmp_x_3_4 = 0,
            s_3_4 = 0,
            scale_v_3_4 = void 0;
        var o_point_67 = { x: 400, y: 240 },
            tmp_x_67 = 0,
            s_67 = 0,
            scale_v_67 = void 0,
                start_X_67 = void 0,
                    hasScaled_67 = false;
        var o_point_89 = { x: 0, y: 340 },
            tmp_x_89 = 0,
            s_89 = 0,
            scale_v_89 = void 0;
        var o_point_910 = { x: 440, y: 50 },
            tmp_x_910 = 0,
            s_910 = 0,
            scale_v_910 = void 0;
        ...
        function initTextScript() {
            ...
            for (var i = 0, len = text_script.length; i < len; i++) {
                ...
                if (i == 11) {
                    textSample = new PIXI.Text(text_script[i], { fontSize: '22px', fill: 'white', align: 'center' });
                    textSample.position.y = -320 - 40;
                    textSample.position.x = distXAxisforW750 / 2 + 20;
                } else {
                    textSample = new PIXI.Text(text_script[i], { fontSize: '30px', fill: 'white', align: 'center' });
        ...
        var act_1_animate_bg_img_arr = [],
            act_1_bird_animate_bg_img_arr = [],
            act_2_animate_bg_img_arr = [],
            act_3_animate_bg_img_arr = [],
            act_3_mos_animate_bg_img_arr = [],
            act_3_tv_animate_bg_img_arr = [],
            act_4_animate_bg_img_arr = [],
            act_5_2_animate_bg_img_arr = [],
            act_5_3_animate_bg_img_arr = [],
            act_7_animate_bg_img_arr = [],
            act_9_animate_bg_img_arr = [],
            act_11_air_animate_bg_img_arr = [],
            act_10_animate_bg_img_arr = [],
            act_8_new_animate_bg_img_arr = [],
            act_11_new_animate_bg_img_arr = [],
            act_1_hand = [],
            act_hole = [];
        for (var $e = 0; $e < 11; $e++) {
            act_1_animate_bg_img_arr.push(urlPadding + "new-1-sky-" + ($e + 1) + ".jpg");
        }
        for (var _$e = 0; _$e < 22; _$e++) {
            act_1_bird_animate_bg_img_arr.push(urlPadding + "new-1-bird-" + (_$e + 1) + ".png");
        }
        for (var _$e2 = 0; _$e2 < 5; _$e2++) {
            act_1_hand.push(urlPadding + "new-114-left-" + (_$e2 + 1) + ".png");
        }
        for (var _$e3 = 0; _$e3 < 16; _$e3++) {
            act_11_new_animate_bg_img_arr.push(urlPadding + "new-114-car-v1-" + (_$e3 + 1) + ".jpg");
        }

        for (var _$e4 = 0; _$e4 < 14; _$e4++) {
            act_3_mos_animate_bg_img_arr.push(urlPadding + "new-3-mos-" + (_$e4 + 1) + ".jpg");
        }
        for (var _$e5 = 0; _$e5 < 9; _$e5++) {
            act_3_tv_animate_bg_img_arr.push(urlPadding + "new-3-tv-" + (_$e5 + 1) + ".jpg");
        }

        for (var _$e6 = 0; _$e6 < 57; _$e6++) {
            act_hole.push(urlPadding + "new-114-hole2-" + (_$e6 + 1) + ".jpg");
        }
        for (var _$e7 = 0; _$e7 < 8; _$e7++) {
            act_5_2_animate_bg_img_arr.push(urlPadding + "9-2-" + (_$e7 + 1) + ".png");
        }

        for (var _$e8 = 0; _$e8 < 14; _$e8++) {
            act_7_animate_bg_img_arr.push(urlPadding + "bat-" + (_$e8 + 1) + ".png");
        }
        for (var _$e9 = 0; _$e9 < 12; _$e9++) {
            act_2_animate_bg_img_arr.push(urlPadding + "new-2-win-" + (_$e9 + 1) + ".jpg");
        }
        for (var _$e10 = 0; _$e10 < 13; _$e10++) {
            act_8_new_animate_bg_img_arr.push(urlPadding + "new-114-gho-" + (_$e10 + 1) + ".jpg");
        }

        for (var _$e11 = 0; _$e11 < 5; _$e11++) {
            act_11_air_animate_bg_img_arr.push(urlPadding + "new-114-car-t-" + (_$e11 + 1) + ".png");
        }
        for (var _$e12 = 0; _$e12 < 26; _$e12++) {
            act_10_animate_bg_img_arr.push(urlPadding + "new-10-sky-" + (_$e12 + 1) + ".jpg");
        }

        function storyInit() {

            pixiLoader.add(urlPadding + "new-1-1.jpg").add(urlPadding + "new-1-2.png").add(urlPadding + "new-1-3.png?t=1").add(urlPadding + "mask.png").add(urlPadding + "tree1.png").add(urlPadding + "tree2.png").add(urlPadding + 'new-114-8-bgh.jpg').add(urlPadding + "tree.png").add(urlPadding + "wall.jpg?t=1").add(urlPadding + "new-2-1.jpg").add(urlPadding + "new-2-2.png").add(urlPadding + "new-2-3.png").add(urlPadding + "new-3-1.jpg").add(urlPadding + "new-3-2.png").add(urlPadding + "new-3-3.png").add(urlPadding + "new-5-1.jpg").add(urlPadding + "new-114-wolf-bg.png").add(urlPadding + "new-5-3.png").add(urlPadding + "new-5-4.png").add(urlPadding + "6-1.png").add(urlPadding + "new-6-bag.png").add(urlPadding + "new-114-book.png").add(urlPadding + "new-6-smallbook.png").add(urlPadding + "new-7-1.jpg").add(urlPadding + "new-7-2.png").add(urlPadding + "new-7-3.png").add(urlPadding + "new-10-1.png").add(urlPadding + "new-114-moon-human.png").add(urlPadding + "new-10-3.png").add(urlPadding + "new-10-4.jpg").add(act_1_animate_bg_img_arr).add(act_1_bird_animate_bg_img_arr).add(urlPadding + "new-114-person1.png").add(urlPadding + "new-114-person2.png").add(urlPadding + "new-114-1-talk.png").add(urlPadding + "new-114-2-talk.png").add(urlPadding + "new-114-btn-fake.png").add(urlPadding + "b.jpg").add(urlPadding + "new-114-hand.png").add(urlPadding + "new-114-alpha.png").add(act_2_animate_bg_img_arr).add(act_1_hand).add(act_3_mos_animate_bg_img_arr).add(act_3_tv_animate_bg_img_arr).add(act_11_air_animate_bg_img_arr).add(act_5_2_animate_bg_img_arr).add(act_7_animate_bg_img_arr).add(act_hole).add(act_10_animate_bg_img_arr).add(act_8_new_animate_bg_img_arr).add(act_11_new_animate_bg_img_arr).on("progress", setProgress).load(loadingFinish);
        }
        ...
        act_1_sprites_arr = [{
            ...
            name: "front-2",
            url: urlPadding + "new-1-bird-1.png",
            position: { x: 331 - 200, y: 203 },
            speed: { x: -.18, y: 0 },
            gif: true,
            fromImages: act_1_bird_animate_bg_img_arr
        }, {
            name: "front-5",
            url: urlPadding + "new-114-alpha.png",
            position: { x: 0, y: 0 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "front-6",
            url: urlPadding + "new-114-left-1.png",
            position: { x: 604 - 140, y: 258 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_1_hand
        }];

        act_2_sprites_arr = [{ name: "bg-2", url: urlPadding + "new-2-1.jpg", position: { x: 1500, y: 0 }, speed: { x: 0, y: 0 }, gif: false }, { name: "mid-2", url: urlPadding + "new-2-2.png", position: { x: 2685, y: 390 }, speed: { x: -.1, y: 0 }, gif: false }, {
            name: "front-2",
            url: urlPadding + "new-2-3.png",
            position: { x: 1500 - 100, y: 0 },
            speed: { x: 0, y: 0 },

            gif: false
        }, {
            name: "front-3",
            url: urlPadding + "new-2-win-1.jpg",
            position: { x: 1500 + 738, y: 272 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_2_animate_bg_img_arr
        }, { name: "mask-2-1", url: urlPadding + "tree1.png", position: { x: 1240, y: 0 }, speed: { x: -.15, y: 0 }, gif: false }];

        act_3_sprites_arr = [{ name: "bg-3", url: urlPadding + "new-3-1.jpg", position: { x: 2600 - 200, y: 0 }, speed: { x: 0, y: 0 }, gif: false }, {
            name: "bg-3-mos",
            url: urlPadding + "new-1-mos-1.jpg",
            position: { x: 2600 + 719 - 200, y: 309 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_3_mos_animate_bg_img_arr
        }, {
            name: "mid-3",
            url: urlPadding + "new-3-2.png",
            position: { x: 2683 + 100 - 200, y: 0 },

            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "front-3",
            url: urlPadding + "new-3-3.png",
            position: { x: 2600 + 100 - 200 - 140, y: 0 },

            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "bg-3-tv",
            url: urlPadding + "new-1-tv-1.jpg",
            position: { x: 2600 + 150 + 100 + 72 - 200 - 140, y: 490 },

            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_3_tv_animate_bg_img_arr
        }, {
            name: "mid-4",
            url: urlPadding + "new-114-1-talk.png",
            position: { x: 2683 + 100 + 358 - 200, y: 209 },

            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "mid-5",
            url: urlPadding + "new-114-2-talk.png",
            position: { x: 2683 + 100 + 568 - 200, y: 143 },

            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "cover",
            url: urlPadding + "b.jpg",
            position: { x: 2400, y: 0 },
        ...
        act_5_sprites_arr = [{ name: "bg-5", url: urlPadding + "new-5-1.jpg", position: { x: 3900, y: 0 }, speed: { x: 0, y: 0 }, gif: false }, {
            name: "wolve-5",
            url: urlPadding + "new-5-4.png",
            position: { x: 3900 + 823, y: 278 - 22 },
            speed: { x: -.16, y: 0 },
            gif: false
        }, {
            name: "mid-5",
            url: urlPadding + "new-114-wolf-bg.png",
            position: { x: 3900, y: 0 },
            speed: { x: -.1, y: 0 },
            gif: false
        }, {
            name: "bg-5-wolf-2",
            url: urlPadding + "9-2-1.png",
            position: { x: 3900, y: 465 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_5_2_animate_bg_img_arr
        }, {
            name: "front-5",
            url: urlPadding + "new-5-3.png",
            position: { x: 3900 + 100, y: 0 },
            speed: { x: -.3, y: 0 },
            gif: false
        }, {
            name: "cover",
        ...
        act_6_sprites_arr = [{ name: "bg-6", url: urlPadding + "6-1.png", position: { x: 4900 + 500, y: 0 }, speed: { x: 0, y: 0 }, gif: false }, {
            name: "smallbook-6",
            url: urlPadding + "new-6-smallbook.png",
            position: { x: 4900 + 500 + 641, y: 281 },
            speed: { x: 0, y: 0 }, gif: false
        }, {
            name: "bag-6",
            url: urlPadding + "new-6-bag.png",
            position: { x: 4900 + 500 + 566, y: 123 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "book-6",
            url: urlPadding + "new-114-book.png",
            position: { x: 4900 + 500 + 460 + 200, y: 144 },
            speed: { x: -.2, y: 0 }, gif: false
        }, {
            name: "mask-6-0",
            url: urlPadding + "tree2.png",
            position: { x: 4900 + 500 - 320, y: 0 },
            speed: { x: -.15, y: 0 },
            gif: false
        }];

        act_7_sprites_arr = [{ name: "bg-7", url: urlPadding + "new-7-1.jpg", position: { x: 9600 + 500 - 3200, y: 0 }, speed: { x: 0, y: 0 }, gif: false }, {
            name: "mid-7",
            url: urlPadding + "new-7-2.png",
            position: { x: 9620 + 500 - 3200, y: 0 },
            speed: { x: -.15, y: 0 },
            gif: false
        }, {
            name: "front-7",
            url: urlPadding + "new-7-3.png",
            position: { x: 9600 + 500 - 3200, y: 0 },
            speed: { x: -.22, y: 0 },
            gif: false
        }, {
            name: "front-bat",
            url: urlPadding + "bat-1.png",
            position: { x: 9620 + 670 + 100 + 100 + 500 - 3400, y: 0 },
            speed: { x: -.15, y: 0 },
            gif: true,
            fromImages: act_7_animate_bg_img_arr
        }, {
            name: "front-hand",
            url: urlPadding + "new-114-hand.png",
            position: { x: 9620 + 500 - 3200 + 588, y: 348 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "mask-6-0",
            url: urlPadding + "tree2.png",
            position: { x: 9350 + 500 - 3200, y: 0 },
            speed: { x: -.20, y: 0 },
            gif: false
        }];
        ...
        act_8_1_sprites_arr = [{
            ...
            position: { x: 11405 - 240, y: 0 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "bg-8-2-1-new",
            url: urlPadding + "black-11.jpg",
            position: { x: 8651 + 400, y: 0 },
            speed: { x: -.02, y: 0 },
            gif: true,
            fromImages: act_8_new_animate_bg_img_arr
        }];

        act_8_sprites_arr = [{
            name: "bg-8-1-new",
            url: urlPadding + "new-114-hole2-1.jpg",
            position: { x: 10405 + 240, y: 0 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_hole
        }];
        ...
        act_10_sprites_arr = [{
            name: "bg-9-1",
            url: urlPadding + "new-10-4.jpg",
            position: { x: 11052 - 55, y: 0 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_10_animate_bg_img_arr
        }, {
            name: "bg-9-2",
            url: urlPadding + "new-10-3.png",
            position: { x: 11134 - 55, y: 750 - 222 },
            speed: { x: -.1, y: 0 },
            gif: false
        }, {
            name: "mid-9",
            url: urlPadding + "new-114-moon-human.png",
            position: { x: 11052 - 55, y: 0 },
            speed: { x: -.15, y: 0 },
            gif: false
        }, {
            name: "mid-9",
            url: urlPadding + "new-114-person1.png",
            position: { x: 12057 - 55, y: 312 },
            speed: { x: -.15, y: 0 },
            gif: false
        }, {
            name: "mid-9",
            url: urlPadding + "new-114-person2.png",
            position: { x: 11933 - 55, y: 312 },
            speed: { x: -.15, y: 0 },
            gif: false
        }, {
            name: "front-9",
            url: urlPadding + "new-10-1.png",
            position: { x: 11052 - 55, y: 750 - 356 },
            speed: { x: -.3, y: 0 },
            gif: false
        }, {
            name: "mask-9",
            url: urlPadding + "mask.png",
            position: { x: 10702 - 55, y: 0 },
            speed: { x: -.18, y: 0 },
            gif: false
        }, {
            name: "cover",
            url: urlPadding + "new-114-hole2-57.jpg",
            position: { x: 11052 - 55, y: 0 },
            speed: { x: 0, y: 0 },
            gif: false
        }];
        ...
        act_11_sprites_arr = [{
            name: "bg-11",
            url: urlPadding + "new-114-car-v1-1.jpg",
            position: { x: 11710 + 300 - 68 - 80 + 10 + 20, y: 0 },
            speed: { x: 0, y: 0 },
            gif: true,
            fromImages: act_11_new_animate_bg_img_arr
        }, { name: "btn-0", url: urlPadding + "new-114-btn-fake.png", position: { x: 12256 + 300 - 68 - 80 + 10 + 20, y: 355 }, speed: { x: 0, y: 0 } }, { name: "btn-1", url: urlPadding + "new-114-btn-fake.png", position: { x: 12256 + 300 - 68 - 80 + 10 + 20, y: 465 }, speed: { x: 0, y: 0 } }, {
            name: "bg-11",
            url: act_11_air_animate_bg_img_arr[0],
            position: { x: 11984 + 300 - 68 - 80 + 10 + 20 + 100, y: 606 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "bg-11",
            url: act_11_air_animate_bg_img_arr[1],
            position: { x: 12400 + 300 - 68 - 80 + 10 + 20 + 100, y: 606 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "bg-11",
            url: act_11_air_animate_bg_img_arr[2],
            position: { x: 12272 + 300 - 68 - 80 + 10 + 20 + 100, y: 606 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "bg-11",
            url: act_11_air_animate_bg_img_arr[3],
            position: { x: 11804 + 300 - 68 - 80 + 10 + 20 + 100, y: 587 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "bg-11",
            url: act_11_air_animate_bg_img_arr[4],
            position: { x: 12616 + 300 - 80 + 10 + 20 + 100, y: 606 },
            speed: { x: 0, y: 0 },
            gif: false
        }, {
            name: "cover",
            url: urlPadding + "b.jpg",
            position: { x: 11862 + 10 + 20, y: 0 },
        ...
        function loadingFinish() {
            ...
            var scenes = [Act_1, Act_2, Act_3, Act_5, Act_6, Act_7, Act_8_1, Act_8, Act_10, Act_11];

            act_sprites_list = [act_1_sprites_arr, act_2_sprites_arr, act_3_sprites_arr, act_5_sprites_arr, act_6_sprites_arr, act_7_sprites_arr, act_8_1_sprites_arr, act_8_sprites_arr, act_10_sprites_arr, act_11_sprites_arr];
            ...
            Act_11.children[1].interactive = true;
            Act_11.children[1].buttonMode = true;
            Act_11.children[2].interactive = true;
            Act_11.children[2].buttonMode = true;
            Act_8_1.buttonMode = true;
            Act_8_1.interactive = true;
            Act_8_1.on("touchstart", function (e) {
                showFaceTouch++;
            ...
            Act_11.children[1].on("touchstart", function (e) {
                window.location.href = window.url;
            });
            Act_11.children[2].on("touchstart", function (e) {
                $('.js_click_fake').trigger('click');
                $('.js_mask_share').removeClass('hide');
            });
            Act_1.children[5].interactive = true;
            ...
            smallBookSprite = Act_6.children[1];
            leftLimit = {
                x: smallBookSprite.data.position.x - smallBookMove,
                y: smallBookSprite.data.position.y
            };
            startPosition = smallBookSprite.data.position;

            openBookSprite = Act_6.children[3];
            openBookSprite.visible = false;
            openBookSprite.scale.set(0.5);

            openBookSprite.x = leftLimit.x;
            runningWolf = Act_5.children[3];
            startPositionW = runningWolf.data.position;
            runningWolf.visible = false;
            runningWolf.scale.set(2);

            wolfSprite = Act_5.children[1];
            wolfSprite.visible = false;

            handSprite = Act_7.children[4];
            handSprite.visible = false;
            Act_8_1.children[2].visible = false;
            face = Act_8_1.children[4];
            leftWall = Act_3.children[5];
            leftWall.visible = false;

            Act_3.visible = false;
            Act_5.visible = false;
            Act_6.visible = false;
            Act_8_1.visible = false;
            Act_10.visible = false;
            Act_11.visible = false;
            face.visible = false;
            ...
            Act_11.children[3].visible = false;
            Act_11.children[4].visible = false;
            Act_11.children[5].visible = false;
            Act_11.children[6].visible = false;
            Act_11.children[7].visible = false;
            pageUpdate();
        }
        ...
        var audio_array = [{ dom_ref: $("#ms_crown")[0], start: 60, end: 160, isPlayed: false }, { dom_ref: $("#ms_wolf_bgm")[0], start: 4039, end: 4324, isPlayed: false }, { dom_ref: $("#ms_book")[0], start: 5520, end: 5700, isPlayed: false }, { dom_ref: $("#ms_bat")[0], start: 6790, end: 6900, isPlayed: false }, { dom_ref: $("#ms_heart_beating")[0], start: 7906, end: 8700, isPlayed: false }, { dom_ref: $("#ms_screaming")[0], start: 8500, end: 8900, isPlayed: false }, { dom_ref: $("#ms_canival_bgm")[0], start: 11935 - 80, end: 11945 - 80 + 1500, isPlayed: false }];

        function sceneAnimation1(cur_X, left, top, s_1_bird, s_1_sky) {
            ...
            Act_1.children[5].animationSpeed = 0.1;
            Act_1.children[5].play();

            s_1_bird.animationSpeed = 0.2;
            if (cur_X > 0) {
                Act_1.children[5].visible = false;
                Act_1.children[4].visible = false;
            }

            for (var i = 0; i < Act_1.children.length; i++) {
                var p = Act_1.children[i];
                if (p.data.speed) {
            ...
            if (!birdPlaying) {
                ...
                birdInter = setInterval(function () {
                    if (!birdPlaying) {
        ...
        var switchX = {
            ...
            to8: 9609,
            to9: 10900 };
        function sceneAnimation2(cur_X, left, top, s_2_win, s_3_mos, s_3_tv) {
            var distance = cur_X - switchX.to2;

            outDoorAnimate = Act_2.children[0];
            s_2_win.animationSpeed = 0.15;
            s_2_win.play();

            for (var i = 0; i < Act_2.children.length - 1; i++) {
                var p = Act_2.children[i];
                if (p.data.speed) {
                    p.x = p.data.position.x + p.data.speed.x * distance;
                    p.y = p.data.position.y + p.data.speed.y * distance;
                }
            ...
            showNthCont(999, w, scriptText_con);
            if (cur_X > switchX.to2 + 350 && cur_X < switchX.to2 + 570) {
                showNthCont(1, w, scriptText_con);
            }

            if (cur_X > 1500) {
                tmp_x = (cur_X - 1500) / 400;
                s = tmp_x * tmp_x;
                Act_2.pivot.set(outDoorAnimate.data.position.x - o_point.x * s, outDoorAnimate.data.position.y - o_point.y * s);

                scale_v = 1 + s;

                Act_2.scale.set(scale_v, scale_v);
                Act_2.x = outDoorAnimate.data.position.x + o_point.x * -s;
                Act_2.y = outDoorAnimate.data.position.y + o_point.y * -s;
                for (var i = 0; i < Act_2.children.length; i++) {
                    var p = Act_2.children[i];
            ...
            if (cur_X >= switchX.to3) {
                sceneAnimation3(cur_X, left, top, s_3_mos, s_3_tv);
            }
        ...
        function sceneAnimation3(cur_X, left, top, s_3_mos, s_3_tv) {
        ...
        function sceneAnimation4(cur_X, left, top) {
            ...
            Act_5.children[5].alpha = 1 - distance / 100;
            ...
            function showWolfWalking() {
                var endX = act_5_sprites_arr[0].position.x;

                if (!scrollerAnimatingWolfWalking) {
                    wW.visible = true;
                    scrollerAnimatingWolfWalking = true;
                    new TWEEN.Tween(startPositionWw).to({ x: endX }, 4 * 1000).onUpdate(function () {
                        wW.x = this.x;
                    }).onComplete(function () {
                        wW.visible = false;
            ...
            function showWolfRunning() {
                ...
                if (!scrollerAnimatingWolfRunning) {
                    ...
                    new TWEEN.Tween(startPositionW).to({ x: endX }, 1 * 1000).onUpdate(function () {
        ...
        function sceneAnimation5(cur_X, left, top) {
            var distance = cur_X - switchX.to5;

            for (var i = 0; i < Act_6.children.length; i++) {
                if (i == 1 || i == 3) {
                    continue;
                }
                var p = Act_6.children[i];
                if (p.data.speed) {
                    p.x = p.data.position.x + p.data.speed.x * distance;
                    p.y = p.data.position.y + p.data.speed.y * distance;
                }
            ...
            showNthCont(999, w, scriptText_con);
            if (cur_X > 5477 && cur_X < 5726) {
                showNthCont(4, w, scriptText_con);
            }
            if (cur_X < 3800 || cur_X > 6000) {
                closeOpenBookAnimate();
            }
            if (cur_X > 5500 && cur_X <= 6000) {
                showOpenBookAnimate();
            }
            function closeOpenBookAnimate() {
                if (hasOpen && !scrollerAnimatingClose) {
                    scrollerAnimatingClose = true;
                    var smallBook_tween = new TWEEN.Tween({ x: leftLimit.x }).to(smallBookSprite.data.position, 500).onUpdate(function () {
                        smallBookSprite.x = this.x;
                    }).onComplete(function () {

                        smallBookSprite.visible = true;
                        smallBookSprite.x = smallBookSprite.data.position.x + smallBookMove;
                        hasOpen = false;
                        scrollerAnimatingClose = false;
                    });

                    var openBook_tween = new TWEEN.Tween({
                        scale: 1,
                        x: openBookSprite.data.position.x + openBookSprite.data.speed.x * distance,
                        y: openBookSprite.data.position.y + openBookSprite.data.speed.y * distance
                    }).to({
                        scale: 0,
                        x: leftLimit.x,
                        y: leftLimit.y
                    }, 700).onStart(function () {
                        openBookSprite.visible = true;
                    }).onUpdate(function () {

                        openBookSprite.scale.set(this.scale);
                        openBookSprite.x = this.x;
                        openBookSprite.y = this.y;
                    }).onComplete(function () {
                        openBookSprite.visible = false;
                        scrollerAnimatingClose = true;
                    }).start();
                    ...
                    openBook_tween.chain(smallBook_tween);
                }
            }

            function showOpenBookAnimate() {
                if (!hasOpen && !scrollerAnimating) {

                    scrollerAnimating = true;
                    var smallBook_tween = new TWEEN.Tween(smallBookSprite.data.position).to({ x: leftLimit.x }, 700).onUpdate(function () {
                        smallBookSprite.x = this.x;
                    }).onComplete(function () {
                        smallBookSprite.visible = false;
                    }).start();
                    ...
                    var openBook_tween = new TWEEN.Tween({
                        ...
                        openBookSprite.visible = true;
                        scrollerAnimating = false;
                        hasOpen = true;
                    });

                    smallBook_tween.chain(openBook_tween);
                }
            }
        }
        function sceneAnimation6(cur_X, left, top, blackBat) {
            var distance = cur_X - switchX.to6;
            for (var i = 0; i < Act_7.children.length; i++) {
                var p = Act_7.children[i];
                if (p.data.speed) {
                    p.x = p.data.position.x + p.data.speed.x * distance;
                    p.y = p.data.position.y + p.data.speed.y * distance;
                }
            ...
            showNthCont(999, w, scriptText_con);
            if (cur_X > 6300 && cur_X < 7800) {
                if (cur_X > 6600) {
                    showNthCont(5, w, scriptText_con);
                }
                handSprite.visible = true;
                if (cur_X >= 6900) {
                    handSprite.y = 348 + (cur_X - 7000) / 2;
                } else {
                    handSprite.y = 348 - (cur_X - 6900) / 2;
                }
            } else {
                handSprite.visible = false;
            }

            blackBat.visible = false;

            if (cur_X > 6784 && cur_X < 8000) {
                if (!bfPlaying) {
                    bfPlaying = true;
                    blackBat.visible = true;
                    blackBat.animationSpeed = 0.35;
                    blackBat.loop = false;
                    blackBat.onComplete = function () {
                        bfInter = setTimeout(function () {
                            blackBat.visible = true;
                            blackBat.gotoAndPlay(0);
                        }, 6000);
                    };
                    blackBat.play();
                }
                ...
                if (bfInter) {
                    clearTimeout(bfInter);
                    bfInter = null;
                    bfPlaying = false;
                }
            }

            var start67 = Act_7.children[0];
            if (cur_X > 6884) {
                tmp_x_67 = (cur_X - 6884) / 400;
                s_67 = tmp_x_67 * tmp_x_67 / 3;
                scale_v_67 = 1 + s_67;

                Act_7.pivot.set(start67.data.position.x - s_67 * o_point_67.x, start67.data.position.y - s_67 * o_point_67.y);
                Act_7.scale.set(scale_v_67);

                Act_7.x = start67.data.position.x - o_point_67.x * s_67;
                Act_7.y = start67.data.position.y - o_point_67.y * s_67;

                for (var i = 0; i < Act_7.children.length; i++) {
                    var p = Act_7.children[i];

                    if (i !== 4) {
                        p.x = p.data.position.x - o_point_67.x * s_67 + p.data.speed.x * distance;
                        p.y = p.data.position.y - o_point_67.y * s_67 + p.data.speed.y * distance;
                    }
                }
                handSprite.scale.set(1);

                if (cur_X > switchX.to7) {
                    if (!hasJumpTo7) {
                        Act_7.visible = false;
                        Act_8_1.visible = true;
                        hasJumpTo7 = true;
                    }
                    sceneAnimation7(cur_X, left, top);
                } else {
                    if (hasJumpTo7) {
                        Act_7.visible = true;
                        Act_8_1.visible = false;
                ...
                Act_7.visible = true;
                Act_7.x = start67.data.position.x;
            }
        }
        function showHandMove() {
            ...
            if (!handSpriteAnimating) {
                ...
                new TWEEN.Tween({ y: 750 }).to({ y: endY }, 2 * 1000).onUpdate(function () {
                    handSprite.y = this.y;
                }).onComplete(function () {
                    handSprite.visible = true;
                }).start();
        ...
        function sceneAnimation7(cur_X, left, top) {
            showNthCont(999, w, scriptText_con);
            if (cur_X > 7765 && cur_X < 8456) {
                showNthCont(6, w, scriptText_con);
            }
            ...
            if (cur_X > 8500) {
                if (showFaceTouch > 1) {
                    if (!faceShowing) {
                        faceShowing = true;
                        face.visible = true;
                        face.animationSpeed = 0.2;
                        face.loop = false;
                        face.onComplete = function () {
                            faceinterval = setTimeout(function () {
                                face.gotoAndPlay(0);
                            }, 6000);
                        };
                        face.play();
        ...
        function sceneAnimation8(cur_X, left, top) {
            var distance = cur_X - switchX.to8;

            for (var i = 0; i < Act_8.children.length; i++) {
                var p = Act_8.children[i];
                if (p.data.speed) {
                    p.x = p.data.position.x + p.data.speed.x * distance;
                    p.y = p.data.position.y + p.data.speed.y * distance;
                }
            ...
            showNthCont(999, w, scriptText_con);
            if (cur_X > 9384 && cur_X < 10250) {
                showNthCont(7, w, scriptText_con);
            }

            var back1 = Act_8.children[0];

            if (cur_X > 10350) {
                var xFrame = Math.round(57 * (cur_X - 10350) / (11000 - 10350));
                xFrame = Math.min(xFrame, 57);

                Act_8.children[0].gotoAndStop(xFrame);
                if (cur_X > 10650 && cur_X < 11000) {
                    Act_8.x = back1.data.position.x + cur_X - 10650;
                }
            }
            if (cur_X > 10720) {
                if (cur_X > 11000) {
                    ...
                    if (faceinterval) {
                        clearTimeout(faceinterval);
                        faceinterval = null;
                        faceShowing = false;
                    }
                    sceneAnimation9(cur_X, left, top);
                } else {
                    if (hasJumpTo9) {
                        Act_10.visible = false;
                        Act_8.visible = true;
        ...
        function sceneAnimation9(cur_X, left, top) {

            var distance = cur_X - 11000;


            Act_10.children[7].alpha = 1 - distance / 100;

            var moonAnimate = Act_10.children[0];
            moonAnimate.animationSpeed = 0.2;
            moonAnimate.play();

            if (distance < 500) {
                for (var i = 0; i < Act_10.children.length; i++) {
                    var p = Act_10.children[i];
                    if (p.data.speed) {
                        p.x = p.data.position.x + p.data.speed.x * distance + distance;
                        p.y = p.data.position.y + p.data.speed.y * distance;
                    }
                }
            } else {
                for (var i = 0; i < Act_10.children.length; i++) {
                    var p = Act_10.children[i];
                    if (p.data.speed) {
                        p.x = p.data.position.x + distance;
                        p.y = p.data.position.y;
                    }
                }
            }

            var a1 = Act_10.children[3],
                a2 = Act_10.children[4];
            a1.visible = false;
            a2.visible = false;
            ...
            if (distance > 100) {
                if (distance < 200) {
                    showNthCont(999, w, scriptText_con);
                    showNthCont(8, w, scriptText_con);
                    a1.visible = true;
                } else if (distance < 400) {
                    a1.visible = false;
                    a2.visible = true;
                    showNthCont(999, w, scriptText_con);
                    showNthCont(9, w, scriptText_con);
                }
            } else {
                a1.visible = false;
                a2.visible = false;
            ...
            var start9 = Act_10.children[0];
            if (distance > 500) {
                tmp_x_910 = (distance - 500) / 300;
                s_910 = tmp_x_910 * tmp_x_910;

                var _tmp_x2 = start9.data.position.x;
                var tmp_y = 0;

                scale_v_910 = 1 + s_910;

                Act_10.scale.set(scale_v_910);

                Act_10.x = _tmp_x2 + o_point_910.x * -s_910;
                Act_10.y = tmp_y + o_point_910.y * -s_910;

                for (var i = 0; i < Act_10.children.length; i++) {
                    var p = Act_10.children[i];

                    p.y = p.data.position.y - o_point_910.y * s_910;
                    p.x = p.data.position.x + p.data.speed.x * 500 + distance - o_point_910.x * s_910;
                }
                ...
                if (cur_X > 11935 - 80) {
                    ...
                    sceneAnimation10(cur_X, left, top);
                } else {
                    if (hasJumpTo10) {
                        Act_11.visible = false;
                        Act_10.visible = true;
                ...
                Act_10.x = start9.data.position.x;
            }
        }
        var animation10Inter = null;var r = 3;
        function sceneAnimation10(cur_X, left, top) {

            var distance = cur_X + 80 - 11935;
            var cv = Act_11.children[0];
            cv.animationSpeed = 0.1;

            cv.play();var mask = Act_11.children[8];
            mask.alpha = 1 - distance / 100;


            if (Act_11.children[8].alpha <= 0) {
                mask.visible = false;
            } else {
                mask.visible = true;
            }
            for (var i = 0; i < Act_11.children.length; i++) {
                var p = Act_11.children[i];
                if (p.data.speed) {
                    p.x = p.data.position.x + p.data.speed.x * distance;
                    p.y = p.data.position.y + p.data.speed.y * distance;
                }
            ...
            if (!hasAnimated10Bubble) {
                hasAnimated10Bubble = true;
                animation10Inter = setInterval(function () {
                    r = Math.floor(Math.random() * 5) + 3;
                    for (var i = 0; i < 5; i++) {
                        if (i + 3 !== r) {
                            Act_11.children[i + 3].visible = false;
                        }
                    }
                    Act_11.children[r].visible = true;
                }, 2000);
            }
        }
        ...
        function scrollerCallback(left, top, zoom) {
            ...
            var s_1_sky = Act_1.children[0],
                s_1_bird = Act_1.children[3],
                s_2_win = Act_2.children[3],
                s_3_mos = Act_3.children[1],
                s_3_tv = Act_3.children[4];
            var blackBat = Act_7.children[3];


            var cv = Act_11.children[0];

            if (cur_X < switchX.to2) {
                sceneAnimation1(cur_X, left, top, s_1_bird, s_1_sky);
            } else if (switchX.to2 <= cur_X && cur_X < switchX.to5) {
                sceneAnimation2(cur_X, left, top, s_2_win, s_3_mos, s_3_tv);
            } else if (switchX.to5 <= cur_X && cur_X < switchX.to6) {
                sceneAnimation5(cur_X, left, top);
            } else if (switchX.to6 <= cur_X && cur_X < switchX.to8) {
                sceneAnimation6(cur_X, left, top, blackBat);
            } else if (switchX.to8 <= cur_X) {
                clearInterval(faceinterval);
                sceneAnimation8(cur_X, left, top);
            }
            ...
            if (cur_X >= 2656) {
                Act_3.children[5].data.speed.x = -.1;
            } else {
                Act_3.children[5].data.speed.x = -.18;
            }

            if (cur_X >= 9200) {
                Act_7.children[2].visible = false;
            } else {
                Act_7.children[2].visible = true;
            }
            ...
            for (var i = 0; i < total; i++) {
                if (i == n && scriptText_con.children[i]) {
                    (function () {
                        ...
                        d.visible = true;
                        new TWEEN.Tween({ alpha: 0 }).to({ alpha: 1 }, 5000).onUpdate(function () {
                            d.alpha = this.alpha;
