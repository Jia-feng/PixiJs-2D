    ...
    (function (module, exports, __webpack_require__) {
        ...
        function storyInit() {
            ...
            pixiLoader.add(urlPadding2 + "pagebg1.jpg")
                ...
                .add(urlPadding2 + "page2/chenzhanwai.png")
        ...
        act_2_sprites_arr = [
            ...
            name: "front-3",
            url: urlPadding2+ "page2/chenzhanwai.png",
            position: {
                x: 7008 + 2302,
                y: 0
            },
        ...
        act_11_sprites_arr = [
            ...
            name: "btn-0",
            url: urlPadding + "new-114-btn-fake.png",
            position: {
                x: 42256 + 300 - 68 - 80 + 10 + 20,
                y: 355
            },
            speed: {
                x: 0,
        ...
        /*function sceneAnimation5(cur_X, left, top) {
            ...
            function closeOpenBookAnimate() {
                if (hasOpen && !scrollerAnimatingClose) {
                    ...
                    var smallBook_tween = new TWEEN.Tween({
                        x: leftLimit.x
                    }).to(smallBookSprite.data.position, 500).onUpdate(function () {
            ...
            function showOpenBookAnimate() {
                if (!hasOpen && !scrollerAnimating) {
                    ...
                    var smallBook_tween = new TWEEN.Tween(smallBookSprite.data.position).to({
                        x: leftLimit.x
    ...
    /*    function sceneAnimation8(cur_X, left, top) {
       ...
       /* function sceneAnimation10(cur_X, left, top) {
        ...
        function scrollerCallback(left, top, zoom) {
            ...
            } else if (cur_X >switchX.to2 && cur_X< switchX.to3) {
                sceneAnimation2(cur_X, left, top, s_2_win, s_3_mos, s_3_tv);
            } else if (cur_X >switchX.to3 && cur_X< switchX.to4) {
                sceneAnimation3(cur_X, left, top, s_2_win, s_3_mos, s_3_tv);
            } else if (cur_X >switchX.to2 && cur_X< switchX.to3) {
                sceneAnimation2(cur_X, left, top, s_2_win, s_3_mos, s_3_tv);
            }
